...
This module assumes that you have deployed a perl application locally using the
L<local::lib/Other-bootstrapping-options> procedure.  Usually you are able to
execute the application only because the PERL5LIB environment variable was
