...
like exception { App::runscript::_prepend_install_lib( 'baz.pl' ) }, qr/\ACannot find script/, 'script is not in PATH';
...
subtest 'successfull execution' => sub {
  ...
  my @got = App::runscript::_prepend_install_lib( basename( $expected_script ), @$expected_args );
